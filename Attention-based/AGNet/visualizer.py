...
# four = torch.tensor(four)
#
# inbody_atten = torch.cat([one,one,one, four])
#
#
#
# body_atten = inbody_atten.tolist()
# body_atten = np.reshape(body_atten,[4,37])
#
#
# ply1 = body_atten[0]
# ply2 = body_atten[1]
